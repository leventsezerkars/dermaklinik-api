...
namespace DermaKlinik.API.Application.Services.Email
{
    public class EmailService : IEmailService
    {
        ...
        private async Task<string> CreateAutoReplyEmailBodyAsync(string name)
        {
            ...
            sb.AppendLine(".header { background-color: #1a1a1a; color: #f5f5f5; padding: 30px 20px; text-align: center; border-bottom: 3px solid #d4af37; }");
            ...
            sb.AppendLine(".highlight { background-color: #fff8e1; padding: 20px; border-left: 4px solid #d4af37; margin: 25px 0; border-radius: 0 5px 5px 0; }");
            ...
            sb.AppendLine(".footer { background-color: #1a1a1a; color: #f0f0f0; padding: 20px; text-align: center; font-size: 14px; border-top: 3px solid #d4af37; }");
            sb.AppendLine(".footer p { margin: 5px 0; }");
            sb.AppendLine(".logo { font-size: 24px; font-weight: bold; margin-bottom: 10px; color: #d4af37; }");
            sb.AppendLine("</style></head>");
            sb.AppendLine("<body>");
